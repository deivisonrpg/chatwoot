...
<template>
  <div
    class="relative flex items-start flex-grow-0 flex-shrink-0 w-auto max-w-full px-4 py-0 border-t-0 border-b-0 border-l-2 border-r-0 border-transparent border-solid cursor-pointer conversation hover:bg-slate-50 dark:hover:bg-slate-800 group"
    :class="{
      'active animate-card-select bg-slate-100 dark:bg-slate-800 border-woot-500':
        isActiveChat,
  ...
  >
    ...
    >
      ...
      <CardLabels v-if="chat.labels.length > 0" :conversation-labels="chat.labels" class="mt-0.5 mx-2 mb-0 overflow-y-hidden">
