...
export default {
  ...
  methods: {
    ...
    onClickSelfAssign() {
      ...
      this.$emitter.emit('custom_change_tab_due_assigned_agent');
...
.reply-box__top {
  ...
  textarea {
    @apply text-sm shadow-none border-transparent bg-transparent m-0 max-h-60 min-h-[3rem] pt-4 pb-0 px-0 resize-none;
  }
}
