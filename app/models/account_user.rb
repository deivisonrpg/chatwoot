...
class AccountUser < ApplicationRecord
  ...
  enum role: { agent: 0, administrator: 1, supervisor: 99 }
  ...
  def create_notification_setting
    ...
    setting.selected_push_flags = [:push_conversation_creation, :push_conversation_assignment, :push_assigned_conversation_new_message,
                                   :push_conversation_mention, :push_participating_conversation_new_message]
    setting.save!
  end
